...
# define PAYLOAD_SIZE 0x3c0a - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x3a95 - FT_MEMCPY_ADDR
...
# define OFFSET_4 0x3aa0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x161c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x3542 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x3551 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x356c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x3562 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3599 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x358f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x35c6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x35bc + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x35f3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x35e9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x3620 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x3616 + BIS_SIZE - FT_MEMCPY_ADDR
