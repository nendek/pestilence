...
# define FT_MEMCPY_ADDR 0x13a0
# define BUF_SIZE 0x20
# define BIS_SIZE 0x191
# define LOADER_SIZE 0xc5
# define PAYLOAD_SIZE 0x31d6 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x310f - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x238b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x249a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x26a7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x311a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x159c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x300e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x301d - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x3038 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x302e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3065 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x305b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x3092 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x3088 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x30bf + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x30b5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x30ec + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x30e2 + BIS_SIZE - FT_MEMCPY_ADDR
