...
# define FT_MEMCPY_ADDR 0x1320
# define BUF_SIZE 0x20
# define BIS_SIZE 0x17c
# define LOADER_SIZE 0x60
# define PAYLOAD_SIZE 0x3127 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x3060 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x235c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x2477 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x2684 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x306b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x151c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2f5f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x2f6e - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x2f89 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x2f7f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x2fb6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x2fac + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x2fe3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x2fd9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x3010 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x3006 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x303d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x3033 + BIS_SIZE - FT_MEMCPY_ADDR
