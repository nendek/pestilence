...
# define FT_MEMCPY_ADDR 0x1380
# define BUF_SIZE 0x20
# define BIS_SIZE 0x177
# define LOADER_SIZE 0xc5
# define PAYLOAD_SIZE 0x31b6 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x30ef - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x236b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x247a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x2687 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x30fa + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x157c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2fee + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x2ffd - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x3018 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x300e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3045 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x303b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x3072 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x3068 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x309f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x3095 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x30cc + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x30c2 + BIS_SIZE - FT_MEMCPY_ADDR
