...
# define FT_MEMCPY_ADDR 0x1260
# define BUF_SIZE 0x20
# define END_SIZE 0x5B
# define LOADER_SIZE 0xCD
# define PAYLOAD_SIZE 0x2809 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x276f - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + END_SIZE + SIGN_SIZE + 4

# define OFFSET_1 0x1eb1 - FT_MEMCPY_ADDR
# define OFFSET_2 0x1fd8 - FT_MEMCPY_ADDR
# define OFFSET_3 0x20fd - FT_MEMCPY_ADDR
