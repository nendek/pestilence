...
# define PAYLOAD_SIZE 0x3bf1 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x3a7c - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x2524 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x2633 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x2842 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x3a87 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x161c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x3529 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x3538 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x3553 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x3549 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3580 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x3576 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x35ad + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x35a3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x35da + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x35d0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x3607 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x35fd + BIS_SIZE - FT_MEMCPY_ADDR
