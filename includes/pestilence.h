...
# define PAYLOAD_SIZE 0x63c2 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x5ea3 - FT_MEMCPY_ADDR
# define MAIN_SIZE 0x63c2 - 0x5ea3 + 0x7
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4a39 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x4941 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4a7b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x5eae + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x197c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x576e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4cb5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5f04 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x577d - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x5798 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x578e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x57c5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x57bb + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x57f2 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x57e8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x581f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x5815 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x584c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x5842 + BIS_SIZE - FT_MEMCPY_ADDR
