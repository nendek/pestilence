...
# define FT_MEMCPY_ADDR 0x1370
# define BUF_SIZE 0x20
# define BIS_SIZE 0x177
# define LOADER_SIZE 0xb5
# define PAYLOAD_SIZE 0x31ac - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x30e5 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x2362 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x2471 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x267e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x30f0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x156c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2fe4 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x2ff3 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x300e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x3004 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x303b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x3031 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x3068 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x305e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x3095 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x308b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x30c2 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x30b8 + BIS_SIZE - FT_MEMCPY_ADDR
