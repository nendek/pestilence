...
# define PAYLOAD_SIZE 0x5233 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x4f3c - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x3f75 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x3e7d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x3fb7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x4f47 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x161c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4be7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x41ed + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x4f9d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4bf6 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4c11 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4c07 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4c3e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4c34 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4c6b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4c61 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x4c98 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x4c8e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x4cc5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x4cbb + BIS_SIZE - FT_MEMCPY_ADDR
