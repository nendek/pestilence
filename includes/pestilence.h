...
# define PAYLOAD_SIZE 0x6393 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x5e74 - FT_MEMCPY_ADDR
# define MAIN_SIZE 0x6393 - 0x5e74 + 0x7
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4a02 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x490a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4a44 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x5e7f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x197c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x573d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4c79 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5ed5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x574c - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x5767 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x575d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x5794 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x578a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x57c1 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x57b7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x57ee + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x57e4 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x581b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x5811 + BIS_SIZE - FT_MEMCPY_ADDR
