...
# define PAYLOAD_SIZE 0x6533 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x6014 - FT_MEMCPY_ADDR
# define MAIN_SIZE 0x6533 - 0x6014 + 0x7
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4aed + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x49f5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4b2f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x601f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x197c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x58b7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4d69 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x6075 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x58c6 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x58e1 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x58d7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x590e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x5904 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x593b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x5931 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x5968 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x595e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x5995 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x598b + BIS_SIZE - FT_MEMCPY_ADDR
