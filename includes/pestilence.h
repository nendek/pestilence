...
# define PAYLOAD_SIZE 0x5adb - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x55bc - FT_MEMCPY_ADDR
...
# define OFFSET_4 0x55c7 + BIS_SIZE - FT_MEMCPY_ADDR
...
# define OFFSET_8 0x561d + BIS_SIZE - FT_MEMCPY_ADDR
