...
# define OFFSET_1 0x30c8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x304b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x310a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x39d7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x161c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x38cb + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x38da - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x38f5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x38eb + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3922 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x3918 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x394f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x3945 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x397c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x3972 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x39a9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x399f + BIS_SIZE - FT_MEMCPY_ADDR
