...
# define PAYLOAD_SIZE 0x63f7 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x5ed8 - FT_MEMCPY_ADDR
# define MAIN_SIZE 0x63f7 - 0x5ed8 + 0x7
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4a3e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x4946 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4a80 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x5ee3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x197c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x5779 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4cb5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5f39 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x5788 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x57a3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x5799 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x57d0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x57c6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x57fd + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x57f3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x582a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x5820 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x5857 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x584d + BIS_SIZE - FT_MEMCPY_ADDR
