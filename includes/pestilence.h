...
# define FT_MEMCPY_ADDR 0x14d0
# define BUF_SIZE 0x20
# define BIS_SIZE 0x2c7
# define LOADER_SIZE 0xca
# define PAYLOAD_SIZE 0x55bc - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x50b1 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x404e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x3f56 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4090 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x50bc + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x170c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4d5c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x42c6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5112 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4d6b - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4d86 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4d7c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4db3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4da9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4de0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4dd6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x4e0d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x4e03 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x4e3a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x4e30 + BIS_SIZE - FT_MEMCPY_ADDR
