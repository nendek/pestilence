...
# define FT_MEMCPY_ADDR 0x16d0
# define BUF_SIZE 0x20
# define BIS_SIZE 0x4c1
# define LOADER_SIZE 0xca
# define PAYLOAD_SIZE 0x57b9 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x52ae - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4245 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x414d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x4287 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x52b9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x190c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4f59 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x44b8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x530f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4f68 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4f83 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4f79 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4fb0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4fa6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4fdd + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4fd3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x500a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x5000 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x5037 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x502d + BIS_SIZE - FT_MEMCPY_ADDR
