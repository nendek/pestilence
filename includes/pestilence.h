...
# define PAYLOAD_SIZE 0x54d0 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x4fc5 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x3f62 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x3e6a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x3fa4 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x4fd0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x161c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4c70 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x41da + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5026 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4c7f - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4c9a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4c90 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4cc7 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4cbd + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4cf4 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4cea + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x4d21 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x4d17 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x4d4e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x4d44 + BIS_SIZE - FT_MEMCPY_ADDR
