...
# define PAYLOAD_SIZE 0x5adf - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x55c0 - FT_MEMCPY_ADDR
...
# define OFFSET_4 0x55cb + BIS_SIZE - FT_MEMCPY_ADDR
...
# define OFFSET_8 0x5621 + BIS_SIZE - FT_MEMCPY_ADDR
