...
# define PAYLOAD_SIZE 0x5c88 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x5769 - FT_MEMCPY_ADDR
# define MAIN_SIZE 0x5c88 - 0x5769 + 0x7
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4318 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x4220 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x435a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x5774 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x197c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x5034 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x4594 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x57ca + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x5043 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x505e + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x5054 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x508b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x5081 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x50b8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x50ae + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x50e5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x50db + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x5112 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x5108 + BIS_SIZE - FT_MEMCPY_ADDR
