...
# define FT_MEMCPY_ADDR 0x12e0
# define BUF_SIZE 0x20
# define BIS_SIZE 0x137
# define LOADER_SIZE 0x60
# define PAYLOAD_SIZE 0x30f2 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x302b - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x231c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x2437 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x2644 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x3036 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x14dc + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2f2a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x2f39 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x2f54 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x2f4a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x2f81 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x2f77 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x2fae + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x2fa4 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x2fdb + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x2fd1 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x3008 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x2ffe + BIS_SIZE - FT_MEMCPY_ADDR
