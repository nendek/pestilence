...
# define FT_MEMCPY_ADDR 0x14e0
# define BUF_SIZE 0x20
# define BIS_SIZE 0x2db
# define LOADER_SIZE 0xca
# define PAYLOAD_SIZE 0x55d1 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x50c6 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE + 8

# define OFFSET_1 0x4063 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x3f6b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x40a5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x50d1 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x171c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x4d71 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_7 0x42db + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_8 0x5127 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x4d80 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x4d9b + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x4d91 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x4dc8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x4dbe + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x4df5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x4deb + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x4e22 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x4e18 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x4e4f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x4e45 + BIS_SIZE - FT_MEMCPY_ADDR
