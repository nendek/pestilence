...
# define FT_MEMCPY_ADDR 0x1350
# define BUF_SIZE 0x20
# define BIS_SIZE 0x177
# define LOADER_SIZE 0x96
# define PAYLOAD_SIZE 0x31bd - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x30f6 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x2390 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x24ab + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x26b8 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x3101 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x154c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2ff5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x3004 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x301f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x3015 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x304c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x3042 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x3079 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x306f + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x30a6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x309c + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x30d3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x30c9 + BIS_SIZE - FT_MEMCPY_ADDR
