...
# define PAYLOAD_SIZE 0x3171 - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x30aa - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + SIGN_SIZE

# define OFFSET_1 0x23a2 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_2 0x24b1 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_3 0x26c0 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_4 0x30b5 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_5 0x15ac + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_6 0x2fa9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_RIP 0x2fb8 - FT_MEMCPY_ADDR

# define OFFSET_HOOK_1 0x2fd3 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_1 0x2fc9 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_2 0x3000 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_2 0x2ff6 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_3 0x302d + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_3 0x3023 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_4 0x305a + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_4 0x3050 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_HOOK_5 0x3087 + BIS_SIZE - FT_MEMCPY_ADDR
# define OFFSET_CALL_5 0x307d + BIS_SIZE - FT_MEMCPY_ADDR
